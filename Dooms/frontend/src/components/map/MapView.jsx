          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-blue-200">
            ...
            <div className="border-t border-blue-200 pt-6 mt-6 text-left">
              ...
              <p className="text-sm text-blue-600 mb-3 leading-relaxed">
                Install Leaflet to display an interactive map with OpenStreetMap tiles:
              </p>
              <code className="block bg-blue-100 text-blue-800 px-4 py-3 rounded-lg text-xs font-mono text-center">
                npm install leaflet@1.9.4 react-leaflet@4.2.1
              </code>
              <p className="text-xs text-blue-500 mt-3 text-center">Then restart: npm run dev</p>
            </div>
          </div>
        </div>
